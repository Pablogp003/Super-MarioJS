...
function create () {
    ...
    ('coin-idle', true)
    this.collectibes.create(200, config.height - 40,
...
function collectItem (mario, item) {
    ...
    if (key == 'coin') {
        playAudio('coin-pickup', this, { volumen: 0.1 })
        ...
        playAudio('powerup', this, { volumen: 0.1 })
...
function onHitEnemy (mario, enemy) {
    if (mario.body.touching.down && enemy.body.touching.
    up) {
...
function killMario (game) {
    ...
    playAudio('gameover', game, { volumen: 0.2 })
